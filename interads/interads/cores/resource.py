...
from cores.delegation.responsehandler import ResponseHandler
from cores.exception.exceptions import status_error_handle, ResourceFieldNotFoundException, ConnectionException
...
class Configuration(object):
    def __init__(self, host, auth_handler, handler=None, service_name=None):
        ...
        :type handler: cores.delegation.resources.ResponseHandler
...
class AbstractResource(object):
    ...
    def response_handler(self):
        """
        :return: cores.delegation.resources.ResponseHandler
        """
